                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user.id}>
                                ...
                                <td>{user.role}</td>
                                <td>
                                    <button className="edit-button" onClick={() => handleEditClick(user)}>Chỉnh sửa</button>
                                    <button className="password-button" onClick={() => handlePasswordClick(user)}>Đổi mật khẩu</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
